...
@section('content')
    <h3 class="page-title">@lang('quickadmin.employee.title')</h3>
    {!! Form::open(array(
        'autocomplete' => 'off',
        'method' => 'POST',
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group {{ $errors->has('dob') ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('dob', old('dob'), ['class' => 'form-control date', 'placeholder' => 'YYYY-MM-DD']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('dob'))
                        <p class="help-block">
                            {{ $errors->first('dob') }}
                ...
                <div class="col-xs-3 form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                    ...
                    {!! Form::select('status', [1 => 'Single', 'Married', 'Widowed', 'Widower', 'Divorce'] ,old('status'), ['class' => 'form-control select2', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-3 form-group {{ $errors->has('working_status') ? 'has-error' : '' }}">
                    {!! Form::label('working_status', 'Employement Status*', ['class' => 'control-label']) !!}
                    {!! Form::select('working_status', [1 => 'Regular', 'Project Based'], old('working_status'), ['class' => 'form-control select2', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-3 form-group {{ $errors->has('leave_entitlement') ? 'has-error' : '' }}">
                    {!! Form::label('leave_entitlement', 'Leave Entitlement*', ['class' => 'control-label']) !!}
